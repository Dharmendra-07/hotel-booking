  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex items-center gap-1 mt-2'>
        <StarRating rating={room.rating || 4} /> {/* ✅ pass rating to avoid hardcoded logic inside */}
      ...
      <div className='flex flex-col lg:flex-row mt-6 gap-6'>
        ...
        <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
          {room?.images.length > 1 && room.images.map((image, index) => (
            <img
              onClick={() => setMainImage(image)} // ✅ removed extra index param
              key={`${image}-${index}`} // ✅ better key than just index
              src={image}
              alt='Room Image'
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will br allocated on the grounf floor according to availability. You get a comfertable Two bedrooms apartment has a true city feeling. The price quoted is for two guests, at the guest slot please mark the number of guests to get the exact price for groups. The Guests will be allocated ground floor according to availability. You get the comfertable two bedroom apartment that has a true city feeling. </p>
      </div>
